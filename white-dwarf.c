/*
 * This program solves the following system of two 
 * first order differential equations, which describe 
 * the radial mass distribution inside white dwarf stars
 * 
...
int main (void) 
{
	...
	double r = 0., r1 = 1200.; /*starting from center r=0 */
	 ...
	 * Evolution loop 
	 */
	while ( (r < r1) && (y[1] > 0) )	/* star ends at density = 0 */
	{
